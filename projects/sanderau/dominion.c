...
//refactoring the council room card
{
	//+4 Cards
	int i;
	for (i = 0; i < 4; ++i)//iterator is the wrong way
	{
		drawCard(currentPlayer, state);
	}
...
//refactoring the village card for the cardEffect switch statement
{
	//+1 Card
	drawCard(currentPlayer, state);
...
void great_hall_card(int currentPlayer, struct gameState *state, int handPos)
{
	//+1 Card
	drawCard(currentPlayer, state);
